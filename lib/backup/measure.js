...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'filter_c.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'filter_c.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'filter_c.temp.asm.js';
...
STATICTOP = STATIC_BASE + 12656;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_filter_cpp() } });
...
// {{PRE_LIBRARY}}
  ...
  var _Stime=0;function _Mtime_js(index) {
  ...
  var JSEvents={keyEvent:0,mouseEvent:0,wheelEvent:0,uiEvent:0,focusEvent:0,deviceOrientationEvent:0,deviceMotionEvent:0,fullscreenChangeEvent:0,pointerlockChangeEvent:0,visibilityChangeEvent:0,touchEvent:0,lastGamepadState:null,lastGamepadStateFrame:null,numGamepadsConnected:0,previousFullscreenElement:null,previousScreenX:null,previousScreenY:null,removeEventListenersRegistered:false,staticInit:function () {
      ...
      console.log('[createContext] attributes : ' + Math.round((end-start)*100)/100 + ' ms');
      target = Pointer_stringify(target);
      var canvas;
      ...
      console.log('[createContext] createContext : ' + Math.round((end-start)*100)/100 + ' ms');
...
var _CreateShader = Module["_CreateShader"] = function() {  return Module["asm"]["_CreateShader"].apply(null, arguments) };
var _Filter = Module["_Filter"] = function() {  return Module["asm"]["_Filter"].apply(null, arguments) };
var __GLOBAL__sub_I_filter_cpp = Module["__GLOBAL__sub_I_filter_cpp"] = function() {  return Module["asm"]["__GLOBAL__sub_I_filter_cpp"].apply(null, arguments) };
